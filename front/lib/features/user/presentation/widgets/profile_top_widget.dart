...
class _ProfilTopWidgetState extends ConsumerState<ProfilTopWidget> {
  // Change State<ProfilTopWidget> to ConsumerState<ProfilTopWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        else if (GetIt.instance.get<AuthLocalDataSource>().currentUser?.photo !=
            null)
          SizedBox(
            width: 120,
            height: 120,
            child: ClipRRect(
              borderRadius: BorderRadius.circular(100),
              child: Image.network(
                GetIt.instance.get<AuthLocalDataSource>().currentUser!.photo!,
              ),
            ),
          ),
        Positioned(
                      ...
                      content: Container(
                        ...
                        child: const Column(
                          children: [
                            ...
                            Text(" Your Profile Photo is updated successfully!",
