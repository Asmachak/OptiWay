...
import 'package:front/features/promo/presentation/blocs/state/promo_notifier.dart';
...
final promoNotifierProvider =
  ...
  final reservationUseCases = PromoUseCases(
    getPromoListUsecases: getPromoListUseCases,
  );
  return PromoNotifier(reservationUseCases);
});
